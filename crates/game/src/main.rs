...
const ASSETS_FILE_PATH: &str = "../../assets";
    ...
    App::new()
        .add_plugins((
            DefaultPlugins
                ...
                .set(AssetPlugin {
                    file_path: ASSETS_FILE_PATH.into(),
                    ..default()
                }),
...
fn setup(
    ...
    info!("Animation controls:");
    info!("  - spacebar: play / pause");
    info!("  - arrow up / down: speed up / slow down animation playback");
    info!("  - arrow left / right: seek backward / forward");
    info!("  - return: change animation");
}
